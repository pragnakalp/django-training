...
### 6. Views (`tasks/views.py`) - Standard Django Forms
            ...
            <div class="card-body">
                ...
                {% if deleted_tasks %}
                    <p class="text-muted">
                        ...
                        Deleted tasks are kept here. You can restore them to your task list.
                    </p>
...
### 14. Task Restore Confirmation Template (`tasks/templates/tasks/task_restore_confirm.html`)
...
👉 **Continue to:** [CBV_Introduction.md](CBV_Introduction.md)
