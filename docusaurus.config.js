...
const config = {
  ...
  tagline: 'A hands-on Django training repository designed to teach core concepts including MVC architecture, ORM, forms, authentication, and scalable project structure.',
    ...
    [
      ...
      ({
        docs: {
          ...
          routeBasePath: '/',
          editUrl:
            'https://github.com/pragnakalp/django-training/tree/main/',
        },
        blog: false,
        theme: {
